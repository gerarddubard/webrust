...
//!
//! Provides an automatic web server that creates modern browser-based interfaces
//! for Rust applications with integrated data visualization capabilities.
//!
//! ## Core Features
//!
//! - **Automatic browser launch** - Zero-configuration startup
//! - **Smart server lifecycle** - Auto-shutdown when browser closes  
//! - **Real-time updates** - Bidirectional communication
//! - **Professional theming** - Complete CSS-like styling control
//! - **Data visualization** - Integrated ECharts for interactive charts
//! - **Cross-platform** - Windows, macOS, Linux support
//!
//! ## Integrated Visualization
//!
//! Seamlessly combines text output, tables, and interactive charts:
//!
//! ```ignore
//! #[gui]
//! fn main() {
//!     let sales_data = vec![100.0, 150.0, 200.0, 180.0];
//!     
//!     // Data table
//!     table(&sales_data).header(["Q1", "Q2", "Q3", "Q4"]);
//!     
//!     // Interactive chart
...
//! - **Auto-shutdown**: 3 seconds after browser disconnect
//! - **Safety timeout**: Maximum 30-second runtime
//! - **Resource management**: Automatic cleanup and optimization
//!
//! ## Professional Themes
//!
//! ```ignore
//! #[gui(bg = "navy", fg = "white", font = "Arial", color = "cyan", size = "16px")]
//! fn main() {
//!     println("Professionally styled interface!");
//! }
//! ```
//!
//! ## Chart Integration
//!
//! Built-in support for interactive data visualization:
//! - **Line charts** - Time series and trend analysis
//! - **Bar charts** - Categorical data comparison
//! - **Pie charts** - Proportional data representation  
//! - **Scatter plots** - Correlation and distribution analysis
//!
//! The GUI automatically handles ECharts integration, script execution,
//! and responsive layout for optimal data presentation.
...
#terminal{{background:{};border:2px solid {};border-radius:12px;padding:20px;height:90vh;overflow-y:auto;line-height:1.6}}
