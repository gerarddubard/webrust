...
fn main() {
    ...
    // 1. Line Chart
    println("<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>1. Line Chart — Trends")
        .align("center");
    ...
    // 2. Bar Chart
    println("<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>2. Bar Chart — Comparisons")
        .align("center");
    ...
    // 3. Pie Chart
    println("<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>3. Pie Chart — Proportions")
        .align("center");
    ...
    // 4. Doughnut Chart
    println("<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>4. Doughnut Chart — Categories")
        .align("center");
    ...
    // 5. Radar Chart
    println(
        "<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>5. Radar Chart — Multi-dimensional",
    )
    .align("center");
    ...
    // 6. Area Chart
    println("<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>6. Area Chart — Evolution")
        .align("center");
    ...
    // 7. Scatter Chart
    println(
        "<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>7. Scatter Chart — Distribution",
    )
    .align("center");
    ...
    // 8. Gauge Chart
    println("<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>8. Gauge Chart — Indicators")
        .align("center");
    gauge_chart(87.5);
    ...
    // 9. Funnel Chart
    println("<dodgerblue t2 |dodgerblue !aliceblue r6 w360 h40 m15>9. Funnel Chart — Conversion")
        .align("center");
    ...
    // Footer
    println("<white !navy r6 p6 w420 h50 m20>✨ All 9 chart types are responsive and interactive!")
        .align("center");
