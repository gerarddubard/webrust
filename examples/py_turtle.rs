...
fn main() {
    print("<white b w250 t2 !midnightblue>🐢 WebRust Object Playground")
        .at(*TW / 3, 0.0);
    ...
    let o = object();
    o.color("darkgreen").width(2.0).at(cx, cy + 25.0).dash(10.0, 5.0);
    ...
    let s = 24.0;
    o.polygon(vec![[cx, cy + s + 25.0], [cx + s, cy + 25.0], [cx, cy - s + 25.0], [cx - s, cy + 25.0]]);
    ...
    frame.line(cx - wheel_distance / 2.0, cy + 45.0, cx + wheel_distance / 2.0, cy + 45.0);
    frame.line(
