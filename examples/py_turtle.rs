...
fn main() {
    ...
    println("<cyan b w{lw / 3} t2 |midnightblue mc r8>🐢 WebRust Object Playground")
        .at(0.0, *TH / 2 - 10);
    ...
    print("<white w{lw} |darkgreen r6>Line").at(lx - 20.0, ly - 25.0);
    ...
    print("<white w{lw} |royalblue r6>Polygon").at(lx - 20.0, ly - 25.0);
    ...
    print("<white w{lw} |tomato r6>Rectangle").at(lx - 20.0, ly - 25.0);
    ...
    print("<black w{lw} |gold r6>Square").at(lx - 20.0, ly - 25.0);
    ...
    print("<white w{lw} |deepskyblue r6>Scooter").at(lx - 20.0, ly - 20.0);
    ...
    print("<white w{lw} |magenta r6>Parallelogram").at(lx - 20.0, ly - 25.0);
    ...
    print("<black w{lw} |orange r6>Ellipse").at(lx - 20.0, ly - 25.0);
    ...
    print("<white w{lw} |dodgerblue r6>Arc").at(lx - 20.0, ly - 25.0);
    ...
    print("<white w{lw} |slateblue r6>Color Fan").at(lx - 20.0, ly - 25.0);
    ...
    print("<white w{lw} |crimson r6>Flower").at(lx - 20.0, ly - 25.0);
    ...
    print("<white w{lw} |indigo r6>Spiral").at(lx - 20.0, ly - 25.0);
    ...
    print("<black w{lw} |gold r6>Sun").at(lx - 20.0, ly - 25.0);
}
