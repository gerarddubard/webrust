...
fn main() {
    ...
    const X: (&str, &str, &str) = ("", "", "");
    let table = vec![
        vec![("H", COL_NONMETAL, COL_TEXT), X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, ("He", COL_NOBLE, COL_TEXT)],
        vec![("Li", COL_ALKALI, COL_TEXT), ("Be", COL_ALKALINE, COL_TEXT), X, X, X, X, X, X, X, X, X, X, ("B", COL_METALLOID, COL_TEXT), ("C", COL_NONMETAL, COL_TEXT), ("N", COL_NONMETAL, COL_TEXT), ("O", COL_NONMETAL, COL_TEXT), ("F", COL_HALOGEN, COL_TEXT), ("Ne", COL_NOBLE, COL_TEXT)],
        vec![("Na", COL_ALKALI, COL_TEXT), ("Mg", COL_ALKALINE, COL_TEXT), X, X, X, X, X, X, X, X, X, X, ("Al", COL_POST, COL_TEXT), ("Si", COL_METALLOID, COL_TEXT), ("P", COL_NONMETAL, COL_TEXT), ("S", COL_NONMETAL, COL_TEXT), ("Cl", COL_HALOGEN, COL_TEXT), ("Ar", COL_NOBLE, COL_TEXT)],
        vec![("K", COL_ALKALI, COL_TEXT), ("Ca", COL_ALKALINE, COL_TEXT), ("Sc", COL_TRANSITION, COL_TEXT), ("Ti", COL_TRANSITION, COL_TEXT), ("V", COL_TRANSITION, COL_TEXT), ("Cr", COL_TRANSITION, COL_TEXT), ("Mn", COL_TRANSITION, COL_TEXT), ("Fe", COL_TRANSITION, COL_TEXT), ("Co", COL_TRANSITION, COL_TEXT), ("Ni", COL_TRANSITION, COL_TEXT), ("Cu", COL_TRANSITION, COL_TEXT), ("Zn", COL_TRANSITION, COL_TEXT), ("Ga", COL_POST, COL_TEXT), ("Ge", COL_METALLOID, COL_TEXT), ("As", COL_METALLOID, COL_TEXT), ("Se", COL_NONMETAL, COL_TEXT), ("Br", COL_HALOGEN, COL_TEXT), ("Kr", COL_NOBLE, COL_TEXT)],
        vec![("Rb", COL_ALKALI, COL_TEXT), ("Sr", COL_ALKALINE, COL_TEXT), ("Y", COL_TRANSITION, COL_TEXT), ("Zr", COL_TRANSITION, COL_TEXT), ("Nb", COL_TRANSITION, COL_TEXT), ("Mo", COL_TRANSITION, COL_TEXT), ("Tc", COL_TRANSITION, COL_TEXT), ("Ru", COL_TRANSITION, COL_TEXT), ("Rh", COL_TRANSITION, COL_TEXT), ("Pd", COL_TRANSITION, COL_TEXT), ("Ag", COL_TRANSITION, COL_TEXT), ("Cd", COL_TRANSITION, COL_TEXT), ("In", COL_POST, COL_TEXT), ("Sn", COL_POST, COL_TEXT), ("Sb", COL_METALLOID, COL_TEXT), ("Te", COL_METALLOID, COL_TEXT), ("I", COL_HALOGEN, COL_TEXT), ("Xe", COL_NOBLE, COL_TEXT)],
        vec![("Cs", COL_ALKALI, COL_TEXT), ("Ba", COL_ALKALINE, COL_TEXT), ("La", COL_LANTH, COL_TEXT), ("Hf", COL_TRANSITION, COL_TEXT), ("Ta", COL_TRANSITION, COL_TEXT), ("W", COL_TRANSITION, COL_TEXT), ("Re", COL_TRANSITION, COL_TEXT), ("Os", COL_TRANSITION, COL_TEXT), ("Ir", COL_TRANSITION, COL_TEXT), ("Pt", COL_TRANSITION, COL_TEXT), ("Au", COL_TRANSITION, COL_TEXT), ("Hg", COL_TRANSITION, COL_TEXT), ("Tl", COL_POST, COL_TEXT), ("Pb", COL_POST, COL_TEXT), ("Bi", COL_POST, COL_TEXT), ("Po", COL_POST, COL_TEXT), ("At", COL_HALOGEN, COL_TEXT), ("Rn", COL_NOBLE, COL_TEXT)],
        vec![("Fr", COL_ALKALI, COL_TEXT), ("Ra", COL_ALKALINE, COL_TEXT), ("Ac", COL_ACTIN, COL_TEXT), ("Rf", COL_TRANSITION, COL_TEXT), ("Db", COL_TRANSITION, COL_TEXT), ("Sg", COL_TRANSITION, COL_TEXT), ("Bh", COL_TRANSITION, COL_TEXT), ("Hs", COL_TRANSITION, COL_TEXT), ("Mt", COL_TRANSITION, COL_TEXT), ("Ds", COL_TRANSITION, COL_TEXT), ("Rg", COL_TRANSITION, COL_TEXT), ("Cn", COL_TRANSITION, COL_TEXT), ("Nh", COL_POST, COL_TEXT), ("Fl", COL_POST, COL_TEXT), ("Mc", COL_POST, COL_TEXT), ("Lv", COL_POST, COL_TEXT), ("Ts", COL_HALOGEN, COL_TEXT), ("Og", COL_NOBLE, COL_TEXT)],
        vec![X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X],
        vec![X, X, X, ("La", COL_LANTH, COL_TEXT), ("Ce", COL_LANTH, COL_TEXT), ("Pr", COL_LANTH, COL_TEXT), ("Nd", COL_LANTH, COL_TEXT), ("Pm", COL_LANTH, COL_TEXT), ("Sm", COL_LANTH, COL_TEXT), ("Eu", COL_LANTH, COL_TEXT), ("Gd", COL_LANTH, COL_TEXT), ("Tb", COL_LANTH, COL_TEXT), ("Dy", COL_LANTH, COL_TEXT), ("Ho", COL_LANTH, COL_TEXT), ("Er", COL_LANTH, COL_TEXT), ("Tm", COL_LANTH, COL_TEXT), ("Yb", COL_LANTH, COL_TEXT), ("Lu", COL_LANTH, COL_TEXT)],
        vec![X, X, X, ("Ac", COL_ACTIN, COL_TEXT), ("Th", COL_ACTIN, COL_TEXT), ("Pa", COL_ACTIN, COL_TEXT), ("U", COL_ACTIN, COL_TEXT), ("Np", COL_ACTIN, COL_TEXT), ("Pu", COL_ACTIN, COL_TEXT), ("Am", COL_ACTIN, COL_TEXT), ("Cm", COL_ACTIN, COL_TEXT), ("Bk", COL_ACTIN, COL_TEXT), ("Cf", COL_ACTIN, COL_TEXT), ("Es", COL_ACTIN, COL_TEXT), ("Fm", COL_ACTIN, COL_TEXT), ("Md", COL_ACTIN, COL_TEXT), ("No", COL_ACTIN, COL_TEXT), ("Lr", COL_ACTIN, COL_TEXT)],
    ];
    for row in &table {
        println("<mb0>");
        for &(sym, bg, fg) in row {
            if sym.is_empty() {
                ...
                print(&format!("<{fg} !{bg} w38 h30 m1 p2 r4 t1 |{COL_BORDER} mc>{sym}"));
            }
        }
    }
}
